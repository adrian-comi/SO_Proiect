...
void processDirectory(const char *dirPath, const char *outputDir, const char *ch)
{
...
int main(int argc, char *argv[])
{
    ...
    if(!isalnum(ch))
    {
        printf("Argumentul <c> trebuie sa fie alfanumeric! \n ");
        return 1;
    }
    ...
    processDirectory(inputPath, outputFile, &ch);
